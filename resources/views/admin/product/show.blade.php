<x-admin.app-layout>
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900 flex flex-row h-1/2">
                    <div class="basis-1/2 h-full">
                        ...
                        <div class="relative border basis-1/2 mt-4"
                            x-data="photoCarousel()"
                            x-init="init()">
                    ...
                    <div class="basis-1/2 ml-4">
                        ...
                        <br>
                        <h1 class="text-xl font-bold mt-4 inline-block">價格：</h1>
                        <p class="text-xl text-red-500 inline-block">{{$product->price}}</p>
                        <br>
                        <h1 class="text-xl font-bold mt-4 inline-block">上架狀態：</h1>
                        <p class="text-xl inline-block">{{$shelf_status}}</p>
                        <br>
                ...
                <div class="p-6 text-gray-900 ">
                    ...
                    <div class="flex flex-row">
                        ...
                        <div class="basis-1/2 flex flex-row">
                            <div class="basis-1/3">
                                <a href="{{ route('admin.combination.adminshow',['combination' => $combination] ) }}" class="block mt-4 w-20 h-10 bg-blue-500 hover:bg-blue-700 text-white text-center rounded-lg cursor-pointer">
                                    <p class="pt-2">組合明細</p>
                                </a>
                            </div>
                            <div class="basis-1/3">
                                <a href="{{route('admin.combination.edit',['combination' => $combination])}}" class="block mt-4 w-20 h-10 bg-blue-500 hover:bg-blue-700 text-white text-center rounded-lg cursor-pointer">
                                    <p class="pt-2">編輯組合</p>
                                </a>
                            </div>
    ...
    <script>
        function photoCarousel() {
            return {
                activePhoto: 0,
                photos: {!! json_encode($photos->map(fn($p) => asset('images/' . $p->file_address))) !!},
                init() {
                    setInterval(() => {
